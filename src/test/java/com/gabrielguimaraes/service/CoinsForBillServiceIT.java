...
@SpringBootTest
public class CoinsForBillServiceIT {
    ...
    public static Stream<Arguments> sourceOfBillsAndCoins() {
        return Stream.of(
                Arguments.of(List.of("10", "20"), false, List.of(COINS_10, COINS_20_02)),
                Arguments.of(List.of("20", "10"), false, List.of(COINS_20, COINS_10_02)),
                Arguments.of(List.of("20", "10"), true, List.of(COINS_20, COINS_10_02)));
    }
    ...
    public void givenValidBillString_whenConvertBillIntoLeastNumberOfCoins_thenReturnCorrectResults(
            List<String> bills,
            boolean mostAmount,
        ...
        for (int i = 0; i < bills.size(); i++) {
            ...
            // when
            List<CoinsHolder> actual = coinsForBillService.convertBillIntoLeastNumberOfCoins(billValue, mostAmount);
    ...
    public void givenValidBillString_whenConvertBillIntoLeastNumberOfCoins_thenThrowException(String bill) {
        ...
        // when
        Executable executable = () -> coinsForBillService.convertBillIntoLeastNumberOfCoins(billValue, false);
